        ...
        ok(Utils::Rateomat::check_cdrs('',
            map {
                    ...
                    $_ => {
                        id => $_,
                        rating_status => 'ok',
                        source_customer_cost => sprintf('%6f',$call_costs),
                        destination_customer_cost => sprintf('%6f',0.0),
                        source_reseller_cost => sprintf('%6f',0.0),
                        destination_reseller_cost => sprintf('%6f',0.0),
                    };
                } @cdr_ids
