...
sub check_config {
	unless defined($ProvDB_User) die "Missing provisioning DB user setting.";
	unless defined($ProvDB_Pass) die "Missing provisioning DB password setting.";
	unless defined($AcctDB_User) die "Missing accounting DB user setting.";
    unless defined($AcctDB_Pass) die "Missing accounting DB password setting.";
    unless defined($BillDB_User) die "Missing billing DB user setting.";
	unless defined($BillDB_Pass) die "Missing billing DB password setting.";
}
